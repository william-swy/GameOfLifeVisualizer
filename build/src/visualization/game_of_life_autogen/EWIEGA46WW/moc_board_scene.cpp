/****************************************************************************
** Meta object code from reading C++ file 'board_scene.h'
**
...
#include <memory>
#include "../../../../../src/visualization/board_scene.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'board_scene.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 12), // "cell_entered"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 5), // "x_pos"
QT_MOC_LITERAL(4, 31, 5), // "y_pos"
QT_MOC_LITERAL(5, 37, 9) // "cell_left"

    },
    "BoardScene\0cell_entered\0\0x_pos\0y_pos\0"
    "cell_left"
};
...
void BoardScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cell_entered((*reinterpret_cast< quint64(*)>(_a[1])),(*reinterpret_cast< quint64(*)>(_a[2]))); break;
        case 1: _t->cell_left(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (BoardScene::*)(quint64 , quint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BoardScene::cell_entered)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (BoardScene::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BoardScene::cell_left)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void BoardScene::cell_entered(quint64 _t1, quint64 _t2)
{
